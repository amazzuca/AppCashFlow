...
// === CONSTANTES GLOBALES ===
const LOGO_DATA_URI = "https://hfguard.com/img/logo/logo.png";
...
// Helper for robust base64 encoding to handle UTF-8 characters
const toBase64 = (str) => {
    try {
        return btoa(
...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    if (dataFromUrl) {
        try {
            const decodedJson = fromBase64(dataFromUrl);
             if (decodedJson) {
  ...
  const handleShare = () => {
    ...
    try {
        ...
        if (!base64String) {
            throw new Error("Failed to encode state to Base64");
        }
